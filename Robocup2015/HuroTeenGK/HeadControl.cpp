...
bool CHeadControl::V_Scanball(bool capfinish)
{
	...
	else
	{
		...
		int command_ver = int(0.2 * Theta_ipy * 1024.0 / 300.0);
...
{
	Head_hor = CAM_HOR_U_BOUDARY-100;
	Head_ver = CAM_VER_L_BOUDARY;
	SendPos(Head_hor, Head_ver);
}
...
{
	Head_hor = CAM_HOR_L_BOUDARY-250;
	Head_ver = CAM_VER_L_BOUDARY+70;
	SendPos(Head_hor, Head_ver);
}
